...
CHECKS = [
    {
        "script": REPO_ROOT / "skills" / "hiking" / "scripts" / "add_hike.py",
        "doc": INSTRUCTIONS_DIR / "hike-workflow.instructions.md",
        "required_tokens": [
            "skills/hiking/scripts/add_hike.py",
            "--overwrite",
            "--skip-gpx",
            "--skip-render",
            "--probe",
    ...
    {
        "script": REPO_ROOT / "skills" / "hiking" / "scripts" / "build_hike_gpx.py",
        "doc": INSTRUCTIONS_DIR / "hike-gpx.instructions.md",
        "required_tokens": [
            "skills/hiking/scripts/build_hike_gpx.py",
            "--peak-ll",
            "--trailhead-ll",
            "--via-ll",
            "--descend-via-ll",
