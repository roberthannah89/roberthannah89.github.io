...
Usage
-----
    python skills/hiking/scripts/add_hike.py --spec /tmp/eiger-trail.spec.json
    python skills/hiking/scripts/add_hike.py --spec /tmp/eiger-trail.spec.json --probe
    python skills/hiking/scripts/add_hike.py --print-spec-template
